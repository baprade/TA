...
ax4.plot([5, 5], [0, C], 'b', linewidth=1.5, label='Cerah')
ax4.plot([15, 15], [0, J], 'g', linewidth=1.5, label='Jarang')
ax4.plot([25, 25], [0, S], 'r', linewidth=1.5, label='Sedang')
ax4.plot([35, 35], [0, T], 'y', linewidth=1.5, label='Tebal')
...
FS.set_crisp_output_value("Cerah", 5) 
FS.set_crisp_output_value("Jarang", 15)
FS.set_crisp_output_value("Sedang", 25) 
FS.set_crisp_output_value("Tebal", 35)
...
elif(hari_ini > 10.0 and hari_ini <= 20.0):
  print("Awan Tumbuh Jarang")
  db.child("Uji").child("Sugeno").set("Awan Tumbuh Jarang")
elif(hari_ini > 20.0 and hari_ini <= 30.0):
